using System;
using OwnID.Server.Gigya.Middlewares.SecurityHeaders.Constants;
using OwnID.Server.IAS.Middlewares.SecurityHeaders.Constants;

namespace OwnID.Server.IAS.Middlewares.SecurityHeaders
{
